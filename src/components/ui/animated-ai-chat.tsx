...
export function AnimatedAIChat({ value, setValue, onSendClick }: { value: string; setValue: (value: string) => void; onSendClick: (value: string) => void }) {
    ...
    return (
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-amber-500/10 rounded-full mix-blend-normal filter blur-[128px] animate-pulse" />
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-amber-500/10 rounded-full mix-blend-normal filter blur-[128px] animate-pulse delay-700" />
                <div className="absolute top-1/4 right-1/3 w-64 h-64 bg-amber-700/10 rounded-full mix-blend-normal filter blur-[96px] animate-pulse delay-1000" />
            </div>
            <div className="w-full max-w-3xl mx-auto relative">
                ...
                >
                    ...
                    <motion.div 
                        className="relative backdrop-blur-2xl bg-black/[0.02] rounded-2xl border border-black/[0.05] shadow-2xl"
                        initial={{ scale: 0.98 }}
                        animate={{ scale: 1 }}
                    ...
                    >
                        ...
                        <div className="p-4 border-black/[0.05] flex items-center justify-end gap-4">
